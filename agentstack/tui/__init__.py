...
from agentstack.cli.init import init_project
    ...
    def layout(self) -> list[Module]:
        ...
        return [
            StarBox((0, 0), (self.height, self.width), color=COLOR_BORDER, modules=[
                ...
                # double box half width placed in the center
                Box(
...
class WizardApp(App):
    ...
    def finish(self):
        ...
        self.stop()
        # TODO there's a flash of the app before the project is created
