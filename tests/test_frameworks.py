...
class TestFrameworks(unittest.TestCase):
    ...
    def _get_test_tool_starred(self) -> ToolConfig:
        return ToolConfig(name='test_tool_star', category='test', tools=['test_tool_star'], tools_bundled=True)
    ...
    def test_add_multiple_tools(self):
        ...
        assert ( # ordering is not guaranteed
            ...
            or
            'tools=[*tools.test_tool_star, tools.test_tool' in entrypoint_src
        ) 
